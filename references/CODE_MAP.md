...
> High-signal code locations that define architecture, flow, and decisions — for quick lookup during development and code review.

---

## ⭐ Core Decision Points (Most Important)

These four functions implement the key architectural decisions. Understand them first.
